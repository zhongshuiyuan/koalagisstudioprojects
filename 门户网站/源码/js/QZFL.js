    ...
    (function() {
        ...
        QZFL.cssTransfrom.prototype = {
            ...
            _endTransfrom: function(sname) {
                var elem = this._elem,
                value = QZFL.dom.getStyle(elem, '-webkit-transition-property');
        ...
        QZFL.JsLoader.prototype._load = function(src, doc, opts) {
            ...
            o = this,
            tmp, k, idp = QZFL.JsLoader._idleInstancesIDQueue,
        ...
        QZFL.imports = function(sources, succCallback, opts) {
            ...
            QZFL.media.imagePlusUrl = 'http://qzonestyle.gtimg.cn/ac/qzfl/release/widget/smart_image.js?max_age=1209603';
            ...
            QZFL.widget.tips = {
                path: "http://qzonestyle.gtimg.cn/ac/qzfl/release/widget/tips.js?max_age=1209600",
        ...
        } /*  |xGv00|678862521b550ad0244b5caae838049a */