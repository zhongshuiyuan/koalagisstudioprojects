...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
_$SGLayers.prototype.showLayer = _$SGLayers_showLayer;
_$SGLayers.prototype.hideLayer = _$SGLayers_hideLayer;
_$SGLayers.prototype.getLayerVisibility = _$SGLayers_getLayerVisibility;
_$SGLayers.prototype.getLayersList = _$SGLayers_getLayersList;
function _$SGLayers() {}
function _$SGLayers_showLayer(layerId) { var sgs = SGAPI.SGFramework._getSGS(); if (sgs == null) return null; else return sgs.layers.showLayer(layerId); }
function _$SGLayers_hideLayer(layerId) { var sgs = SGAPI.SGFramework._getSGS(); if (sgs == null) return null; else return sgs.layers.hideLayer(layerId); }
function _$SGLayers_getLayerVisibility(layerId) { var sgs = SGAPI.SGFramework._getSGS(); if (sgs == null) return null; else return sgs.layers.getLayerVisibility(layerId); }
function _$SGLayers_getLayersList() { var sgs = SGAPI.SGFramework._getSGS(); if (sgs == null) return null; else return sgs.layers.getLayersList(); }